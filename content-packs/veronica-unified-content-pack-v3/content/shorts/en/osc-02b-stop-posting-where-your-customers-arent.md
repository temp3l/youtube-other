...
Also measure the cost of maintaining each channel, not only the reach it reports. A platform that creates attention but no qualified conversations can still consume serious capacity. Concentration gives you enough repetition to learn what actually works there. Distribution is stronger when each channel has a clear job. Measure that trade-off explicitly.
