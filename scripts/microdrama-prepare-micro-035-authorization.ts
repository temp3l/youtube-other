...
const child = spawnSync(
  ...
  [
    ...
    "packages/microdrama/src/micro-035-bounded-canary-authorization-preparation.integration.test.ts",
    "-t",
  ...
  ],
  {
    ...
    env: {
      ...process.env,
      MICRO_035_OPERATOR_PREP: "1",
      MICRO_035_PREPARED_AT: process.env.MICRO_035_PREPARED_AT ?? new Date().toISOString(),
    },
    encoding: "utf8",
  }
);
