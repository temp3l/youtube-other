...
const child = spawnSync(
  ...
  [
    ...
    "packages/microdrama/src/micro-034-bounded-canary-authorization-preparation.integration.test.ts",
    "-t",
  ...
  ],
  {
    ...
    env: {
      ...process.env,
      MICRO_034_OPERATOR_PREP: "1",
      MICRO_034_PREPARED_AT: process.env.MICRO_034_PREPARED_AT ?? new Date().toISOString(),
    },
    encoding: "utf8",
  }
);
