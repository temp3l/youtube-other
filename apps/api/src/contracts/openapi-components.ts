  ...
  components: {
    ...
    schemas: {
      ...
      ProjectPage: {
        ...
        required: ["items"],
        properties: {
          items: { type: "array", items: schema("ProjectSummary") },
          nextAfter: { type: "string", minLength: 1, maxLength: 4096 },
        },
      },
      ProjectSummary: {
        type: "object",
      ...
      EpisodePage: {
        ...
        required: ["items"],
        properties: {
          items: { type: "array", items: schema("EpisodeSummary") },
          nextAfter: { type: "string", minLength: 1, maxLength: 4096 },
        },
      },
      EpisodeSummary: {
        type: "object",
        additionalProperties: false,
        required: ["id", "revision", "content", "createdAt", "updatedAt"],
        properties: {
          id: schema("OpaqueId"),
          revision: schema("Revision"),
          content: schema("EpisodeContent"),
      ...
      CapabilityRegistry: {
        ...
        properties: {
          schemaVersion: { type: "string", enum: ["mediaforge.capability.v1"] },
          capabilityVersion: { type: "string", pattern: "^[a-f0-9]{64}$" },
          entitledProfiles: {
            type: "array",
            minItems: 1,
            items: { type: "string" },
          ...
          cells: {
            ...
            items: {
              ...
              properties: {
                ...
                renderProfiles: { type: "array", items: { type: "string" } },
                publicationModes: { type: "array", items: { type: "string" } },
                approvalModes: { type: "array", items: { type: "string" } },
              },
            },
          },
          tenantConfigurableFields: {
      ...
      ResolvedProductionConfiguration: {
        ...
        properties: {
          ...
          voiceProfileVersionId: schema("OpaqueId"),
          requiredReviewGates: {
            type: "array",
            minItems: 1,
            items: { type: "string" },
          },
          configurationRevision: schema("Revision"),
          capabilityVersion: { type: "string", pattern: "^[a-f0-9]{64}$" },
          fingerprint: { type: "string", pattern: "^[a-f0-9]{64}$" },
          provenance: { type: "array", minItems: 1, items: { type: "object" } },
          resolvedAt: schema("DateTime"),
        },
      },
      ...
      ArtifactComparisonMetadata: {
        ...
        required: [
          ...
          "textDiffAvailable",
          "visualDiffAvailable",
          "timestampAwareMediaDiffAvailable",
        ],
        properties: {
          baselineKind: {
            type: "string",
            enum: ["previous", "approved", "source"],
          },
          baselineContentHash: { type: "string", pattern: "^[a-f0-9]{64}$" },
          currentContentHash: { type: "string", pattern: "^[a-f0-9]{64}$" },
          textDiffAvailable: { type: "boolean" },
          visualDiffAvailable: { type: "boolean" },
          timestampAwareMediaDiffAvailable: { type: "boolean" },
        },
      },
      ProductionUnitSnapshotRecord: {
        ...
        properties: {
          snapshotId: schema("OpaqueId"),
          snapshot: schema("ProductionUnitSnapshot"),
          createdAt: schema("DateTime"),
        },
      },
      ProductionUnitSnapshotPage: {
        ...
        properties: {
          items: {
            type: "array",
            items: schema("ProductionUnitSnapshotRecord"),
          },
        },
      },
      ProductionUnitComparison: {
        ...
        required: ["current"],
        properties: {
          current: schema("ProductionUnitSnapshotRecord"),
          previous: schema("ProductionUnitSnapshotRecord"),
          comparison: schema("ArtifactComparisonMetadata"),
        },
      },
      ProductionUnitComparisonPage: {
        ...
        required: ["items"],
        properties: {
          items: { type: "array", items: schema("ProductionUnitComparison") },
        },
      },
      ...
      BulkProductionPreflightResult: {
        type: "object",
        additionalProperties: false,
        required: ["id", "replayed", "status", "selectionFingerprint", "items"],
        properties: {
          id: schema("OpaqueId"),
          replayed: { type: "boolean" },
        ...
        properties: {
          ...
          accepted: {
            ...
            items: {
              type: "object",
              additionalProperties: false,
              required: ["itemId", "workflowRunId", "jobId"],
              properties: {
                itemId: schema("OpaqueId"),
                workflowRunId: schema("OpaqueId"),
                jobId: schema("OpaqueId"),
              },
            },
      ...
      BulkProductionRetryResult: {
        type: "object",
        required: ["id", "retriedItems"],
        additionalProperties: false,
        properties: {
          id: schema("OpaqueId"),
          retriedItems: { type: "integer", minimum: 1 },
        },
      },
      BulkProductionCancellationResult: {
        type: "object",
        required: ["id", "status", "cancellationRequestedJobIds"],
        additionalProperties: false,
        properties: {
          id: schema("OpaqueId"),
      ...
      AssetPage: {
        ...
        required: ["items"],
        properties: {
          items: { type: "array", items: schema("Asset") },
          nextAfter: { type: "string", minLength: 1, maxLength: 4096 },
        },
      },
      ApprovalChallenge: {
      ...
      ApprovalInput: {
        type: "object",
        additionalProperties: false,
        required: ["challengeId", "subjectId", "expectedRevision", "decision"],
        properties: {
      ...
      ReviewQueueItem: {
        ...
        properties: {
          ...
          validity: {
            type: "string",
            enum: ["actionable", "expired", "consumed", "stale", "historical"],
          },
