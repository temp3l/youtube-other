...
export const openApiComponents = {
  components: {
    ...
    schemas: {
      ...
      ResolvedProductionConfiguration: { type: "object", additionalProperties: false, required: ["schemaVersion", "profileId", "supportedLocales", "defaultLocale", "supportedVariants", "approvalMode", "publicationMode", "renderProfile", "requiredReviewGates", "configurationRevision", "capabilityVersion", "fingerprint", "provenance", "resolvedAt"], properties: { schemaVersion: { type: "string", enum: ["mediaforge.capability.v1"] }, profileId: { type: "string" }, supportedLocales: { type: "array", minItems: 1, items: { type: "string" } }, defaultLocale: { type: "string" }, supportedVariants: { type: "array", minItems: 1, items: { type: "string" } }, approvalMode: { type: "string" }, publicationMode: { type: "string" }, renderProfile: { type: "string" }, voiceProfileVersionId: schema("OpaqueId"), requiredReviewGates: { type: "array", minItems: 1, items: { type: "string" } }, configurationRevision: schema("Revision"), capabilityVersion: { type: "string", pattern: "^[a-f0-9]{64}$" }, fingerprint: { type: "string", pattern: "^[a-f0-9]{64}$" }, provenance: { type: "array", minItems: 1, items: { type: "object" } }, resolvedAt: schema("DateTime") } },
