# Episode 065 — The Taxi Arrived Without a Driver
...
The taxi unlocked itself when Daniel approached. There was no driver, but the navigation screen
already displayed his childhood address.

Daniel Price was a stranded traveller when the account began in a rain-soaked city at night. The
first event did not look violent or supernatural. It arrived through routine work, a familiar place
or an ordinary decision. That gave Daniel every reason to stay calm and keep going.

The warning was already present: The booking app warned him not to select a destination from memory.
Daniel documented it, but did not treat it as proof of danger. The surrounding area looked normal.
Doors, equipment and records matched what should have been there, and nothing suggested an immediate
threat.

The doors locked as soon as he sat down. Daniel repeated the observation instead of trusting a first
impression. Timestamps were compared, equipment was restarted and ordinary explanations were tested.
The result remained the same. That repetition removed the easiest possibility: a single mistake.
...
The taxi stopped at places connected to people Daniel had lost. The recurring sounds—rain on glass,
indicator clicks and an idling engine—returned only when the pattern advanced. They remained quiet
enough to ignore, but consistent enough for the audience to recognise before the characters did.

The behaviour followed one rule: The car collected passengers who refused to accept a final goodbye.
Once Daniel understood that rule, the earlier incidents stopped looking random. They formed a
sequence that reacted to every attempt at control.

Daniel began an investigation. Archived records, old reports, maintenance logs and previous witness
...
The radio asked Daniel to choose one person to leave behind. This was the first detail that survived
...
The situation became personal after that. Each stop replayed a memory more accurately than Daniel
remembered it. Until then, Daniel had been protecting a job, a record or a piece of evidence. Now
...
Daniel considered leaving immediately, but the evidence suggested the pattern would follow. Earlier
...
The only workable plan was this: He refused every destination and used the emergency release when
the car slowed. The plan depended on observation rather than strength. The goal was not to destroy
...
review notes once the environment began changing. Daniel reduced the plan to one rule and one
action, then repeated both until hesitation was no longer possible.

One detail remained useful throughout: the threat never changed every part of the environment at
once. Daniel used the unchanged details as anchors—an exact sound, a fixed object, a known time or a
...
At a red light, the taxi offered one final stop where all the dead were waiting. Daniel pulled the
release and jumped before the light changed. Daniel had one opportunity to commit to the plan.
...
The taxi vanished before police arrived. Daniel received a receipt listing his destination as
'Return Pending.'
