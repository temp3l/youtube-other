# Episode 062 — A Child Was Sitting in the Locked Classroom
...
chalk scratching, school bell, and child footsteps

# Narration Script

Clara saw a child writing tomorrow's date on the blackboard inside a classroom locked for years.

Clara Evans was a school caretaker when the account began in an old primary school. The first event
did not look violent or supernatural. It arrived through routine work, a familiar place or an
ordinary decision. That gave Clara every reason to stay calm and keep going.

The warning was already present: A faded sign on the door said attendance must never be taken after
midnight. Clara documented it, but did not treat it as proof of danger. The surrounding area looked
normal. Doors, equipment and records matched what should have been there, and nothing suggested an
immediate threat.

The room was empty when Clara entered, but the chalk was still moving. Clara repeated the
...
The same child appeared in class photographs from different decades. The recurring sounds—chalk
scratching, school bells and child footsteps—returned only when the pattern advanced. They remained
quiet enough to ignore, but consistent enough for the audience to recognise before the characters
did.

The behaviour followed one rule: Each night, the board listed people the school intended to erase by
morning. Once Clara understood that rule, the earlier incidents stopped looking random. They formed
a sequence that reacted to every attempt at control.

Clara began an investigation. Archived records, old reports, maintenance logs and previous witness
...
A sealed register contained children officially never enrolled. This was the first detail that
...
The investigation created a second problem. The more precisely Clara documented the pattern, the
...
The situation became personal after that. One teacher whose name appeared on the board vanished
before sunrise. Until then, Clara had been protecting a job, a record or a piece of evidence. Now
the threat had selected something emotionally difficult to abandon.

Clara tried the safest practical response first: isolate the source, contact help and leave a
...
Clara considered leaving immediately, but the evidence suggested the pattern would follow. Earlier
...
The only workable plan was this: Clara read every forgotten child's name aloud and completed the
attendance register. The plan depended on observation rather than strength. The goal was not to
...
Before acting, Clara tested the idea on a smaller scale. The test created a brief opening and
...
review notes once the environment began changing. Clara reduced the plan to one rule and one action,
...
once. Clara used the unchanged details as anchors—an exact sound, a fixed object, a known time or a
...
The bell rang repeatedly while desks filled with unseen pupils. Clara continued until the final name
answered from directly behind her. Clara had one opportunity to commit to the plan. Reversing course
...
The classroom door opened. The next day, an empty desk appeared in Clara's office with her name on
it.

In the hours afterward, Clara wrote down every detail while the sequence was still fresh. Copies
...
adaptation. The possibility is not simply that the danger survived Clara. It is that the encounter
...
**Primary title:** A Child Was Sitting in the Locked Classroom

**Thumbnail text:** THE ROOM WAS EMPTY

**Description:** Clara Evans encountered a child writing tomorrow's date on a dusty blackboard. What seemed like an isolated event became a pattern that knew exactly how to follow.
