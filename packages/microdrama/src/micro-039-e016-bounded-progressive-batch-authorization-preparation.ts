...
import {
  buildMicro039E016OperatorAuthorizationRecord,
  computeMicro039E016AuthorizationRevisionId,
  loadMicro039E016AssetGenerationApproval,
  loadMicro039E016CostBudgetApproval,
  loadMicro039E016OperatorAuthorization,
  MICRO_039_E016_ASSET_GENERATION_APPROVAL_ID,
  MICRO_039_E016_COST_BUDGET_APPROVAL_ID,
  persistMicro039E016AssetGenerationApproval,
  persistMicro039E016CostBudgetApproval,
  persistMicro039E016OperatorAuthorization,
  type Micro039E016CostBudgetApprovalRecord,
} from "./micro-039-e016-batch-authorization-persistence.js";
import {
  MICRO_039_E016_BATCH_COST_LIMIT_MINOR,
  MICRO_039_E016_BATCH_CURRENCY,
  MICRO_039_E016_BATCH_EPISODE_IDS,
  MICRO_039_E016_BATCH_LOCALES,
  MICRO_039_E016_BATCH_MAXIMUM_TOTAL_PROVIDER_REQUESTS,
  MICRO_039_E016_PRODUCTION_PROVIDERS,
  MICRO_039_E016_TASK_ID,
  MICRO_039_E016_VISUAL_PROFILE_REVISION,
  computeMicro039E016ProviderConfigRevision,
...
export type Micro039E016BoundedProgressiveBatchAuthorizationPreparationInput = {
...
export type Micro039E016BoundedProgressiveBatchAuthorizationPreparationResult = {
...
function buildAssetGenerationApproval(input: {
  ...
  return {
    ...
    approvalId: MICRO_039_E016_ASSET_GENERATION_APPROVAL_ID,
    ...
    scope: {
      ...
      voiceRevision: MICRO_039_E016_VISUAL_PROFILE_REVISION,
...
function buildCostBudgetApproval(input: {
  ...
  readonly operatorId: string;
  readonly approvedAt: string;
}): Micro039E016CostBudgetApprovalRecord {
  return {
    schemaVersion: "mediaforge.microdrama-cost-budget-approval.v1",
    approvalId: MICRO_039_E016_COST_BUDGET_APPROVAL_ID,
    taskId: MICRO_039_E016_TASK_ID,
    costLimitMinor: MICRO_039_E016_BATCH_COST_LIMIT_MINOR,
    currency: MICRO_039_E016_BATCH_CURRENCY,
...
export async function prepareMicro039E016BoundedProgressiveBatchAuthorization(
  input: Micro039E016BoundedProgressiveBatchAuthorizationPreparationInput
): Promise<Micro039E016BoundedProgressiveBatchAuthorizationPreparationResult> {
  const blockers: string[] = [];
  const packRoot = input.packRoot ?? defaultV5PackRoot;
  const operatorId = input.operatorId ?? "operator.microdrama";
  const providerConfigRevision = computeMicro039E016ProviderConfigRevision();
  ...
  if (blockers.length === 0) {
    persistMicro039E016OperatorAuthorization({
      repository: microdramaRepository,
      record: buildMicro039E016OperatorAuthorizationRecord({
        revisionSet,
        operatorId,
  ...
  const finalPreflight = evaluateMicro039E016ProgressiveBatchPreflight({
...
export function micro039E016AuthorizationEvidenceSummary(input: {
  readonly preparation: Micro039E016BoundedProgressiveBatchAuthorizationPreparationResult;
