...
import {
  buildMicro039E014OperatorAuthorizationRecord,
  computeMicro039E014AuthorizationRevisionId,
  loadMicro039E014AssetGenerationApproval,
  loadMicro039E014CostBudgetApproval,
  loadMicro039E014OperatorAuthorization,
  MICRO_039_E014_ASSET_GENERATION_APPROVAL_ID,
  MICRO_039_E014_COST_BUDGET_APPROVAL_ID,
  persistMicro039E014AssetGenerationApproval,
  persistMicro039E014CostBudgetApproval,
  persistMicro039E014OperatorAuthorization,
  type Micro039E014CostBudgetApprovalRecord,
} from "./micro-039-e014-batch-authorization-persistence.js";
import {
  MICRO_039_E014_BATCH_COST_LIMIT_MINOR,
  MICRO_039_E014_BATCH_CURRENCY,
  MICRO_039_E014_BATCH_EPISODE_IDS,
  MICRO_039_E014_BATCH_LOCALES,
  MICRO_039_E014_BATCH_MAXIMUM_TOTAL_PROVIDER_REQUESTS,
  MICRO_039_E014_PRODUCTION_PROVIDERS,
  MICRO_039_E014_TASK_ID,
  MICRO_039_E014_VISUAL_PROFILE_REVISION,
  computeMicro039E014ProviderConfigRevision,
...
export type Micro039E014BoundedProgressiveBatchAuthorizationPreparationInput = {
...
export type Micro039E014BoundedProgressiveBatchAuthorizationPreparationResult = {
...
function buildAssetGenerationApproval(input: {
  ...
  return {
    ...
    approvalId: MICRO_039_E014_ASSET_GENERATION_APPROVAL_ID,
    ...
    scope: {
      ...
      providers: [...MICRO_039_E014_PRODUCTION_PROVIDERS],
      voiceRevision: MICRO_039_E014_VISUAL_PROFILE_REVISION,
...
function buildCostBudgetApproval(input: {
  ...
  readonly operatorId: string;
  readonly approvedAt: string;
}): Micro039E014CostBudgetApprovalRecord {
  return {
    schemaVersion: "mediaforge.microdrama-cost-budget-approval.v1",
    approvalId: MICRO_039_E014_COST_BUDGET_APPROVAL_ID,
    taskId: MICRO_039_E014_TASK_ID,
    costLimitMinor: MICRO_039_E014_BATCH_COST_LIMIT_MINOR,
    currency: MICRO_039_E014_BATCH_CURRENCY,
...
export async function prepareMicro039E014BoundedProgressiveBatchAuthorization(
  input: Micro039E014BoundedProgressiveBatchAuthorizationPreparationInput
): Promise<Micro039E014BoundedProgressiveBatchAuthorizationPreparationResult> {
  const blockers: string[] = [];
  const packRoot = input.packRoot ?? defaultV5PackRoot;
  const operatorId = input.operatorId ?? "operator.microdrama";
  const providerConfigRevision = computeMicro039E014ProviderConfigRevision();
  ...
  if (blockers.length === 0) {
    persistMicro039E014OperatorAuthorization({
      repository: microdramaRepository,
      record: buildMicro039E014OperatorAuthorizationRecord({
        revisionSet,
        operatorId,
  ...
  const finalPreflight = evaluateMicro039E014ProgressiveBatchPreflight({
...
export function micro039E014AuthorizationEvidenceSummary(input: {
  readonly preparation: Micro039E014BoundedProgressiveBatchAuthorizationPreparationResult;
