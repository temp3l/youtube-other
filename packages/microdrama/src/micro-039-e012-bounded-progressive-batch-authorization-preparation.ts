...
import {
  buildMicro039E012OperatorAuthorizationRecord,
  computeMicro039E012AuthorizationRevisionId,
  loadMicro039E012AssetGenerationApproval,
  loadMicro039E012CostBudgetApproval,
  loadMicro039E012OperatorAuthorization,
  MICRO_039_E012_ASSET_GENERATION_APPROVAL_ID,
  MICRO_039_E012_COST_BUDGET_APPROVAL_ID,
  persistMicro039E012AssetGenerationApproval,
  persistMicro039E012CostBudgetApproval,
  persistMicro039E012OperatorAuthorization,
  type Micro039E012CostBudgetApprovalRecord,
} from "./micro-039-e012-batch-authorization-persistence.js";
import {
  MICRO_039_E012_BATCH_COST_LIMIT_MINOR,
  MICRO_039_E012_BATCH_CURRENCY,
  MICRO_039_E012_BATCH_EPISODE_IDS,
  MICRO_039_E012_BATCH_LOCALES,
  MICRO_039_E012_BATCH_MAXIMUM_TOTAL_PROVIDER_REQUESTS,
  MICRO_039_E012_PRODUCTION_PROVIDERS,
  MICRO_039_E012_TASK_ID,
  MICRO_039_E012_VISUAL_PROFILE_REVISION,
  computeMicro039E012ProviderConfigRevision,
...
export type Micro039E012BoundedProgressiveBatchAuthorizationPreparationInput = {
...
export type Micro039E012BoundedProgressiveBatchAuthorizationPreparationResult = {
...
function buildAssetGenerationApproval(input: {
  ...
  return {
    ...
    approvalId: MICRO_039_E012_ASSET_GENERATION_APPROVAL_ID,
    ...
    scope: {
      ...
      voiceRevision: MICRO_039_E012_VISUAL_PROFILE_REVISION,
...
function buildCostBudgetApproval(input: {
  ...
  readonly operatorId: string;
  readonly approvedAt: string;
}): Micro039E012CostBudgetApprovalRecord {
  return {
    schemaVersion: "mediaforge.microdrama-cost-budget-approval.v1",
    approvalId: MICRO_039_E012_COST_BUDGET_APPROVAL_ID,
    taskId: MICRO_039_E012_TASK_ID,
    costLimitMinor: MICRO_039_E012_BATCH_COST_LIMIT_MINOR,
    currency: MICRO_039_E012_BATCH_CURRENCY,
...
export async function prepareMicro039E012BoundedProgressiveBatchAuthorization(
  input: Micro039E012BoundedProgressiveBatchAuthorizationPreparationInput
): Promise<Micro039E012BoundedProgressiveBatchAuthorizationPreparationResult> {
  const blockers: string[] = [];
  const packRoot = input.packRoot ?? defaultV5PackRoot;
  const operatorId = input.operatorId ?? "operator.microdrama";
  const providerConfigRevision = computeMicro039E012ProviderConfigRevision();
  ...
  if (blockers.length === 0) {
    persistMicro039E012OperatorAuthorization({
      repository: microdramaRepository,
      record: buildMicro039E012OperatorAuthorizationRecord({
        revisionSet,
        operatorId,
  ...
  const finalPreflight = evaluateMicro039E012ProgressiveBatchPreflight({
...
export function micro039E012AuthorizationEvidenceSummary(input: {
  readonly preparation: Micro039E012BoundedProgressiveBatchAuthorizationPreparationResult;
