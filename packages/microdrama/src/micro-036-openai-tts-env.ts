...
import type { Micro036BatchLocale } from "./micro-036-batch-bindings.js";
...
function resolveLocaleVoiceFromEnv(locale: Micro036BatchLocale): string {
  switch (locale) {
    case "en-US":
      return (
...
export function resolveMicro036OpenAiTtsModelConfigurationForLocale(
...
export {
  resolveMicro035OpenAiTtsModelConfigurationForLocale,
} from "./micro-035-openai-tts-env.js";
