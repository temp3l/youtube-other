...
const scenePurposes = ["Datensatz und Leitfrage öffnen.", "Das überprüfbare Lernziel transparent machen.", "Liste oder Diagramm aus dem gebundenen Datensatz modellieren.", "Ableitungen und Lösung geordnet erklären.", "Die Fehlvorstellung sichtbar machen und korrigieren.", "Den Transferdatensatz selbstständig auswerten.", "Eine Entscheidung mit Denkzeit einfordern.", "Die geprüfte Transferlösung auflösen.", "Datensatz, Skala und Ergebnis sichern."] as const;
...
function buildSpecification(definition: ContentDefinition): ProductionLessonContent {
  ...
  const sceneFacts = [[], [], ["example-main-source", ...exampleDerived], ["example-main-source", "example-main-answer"], ["example-main-answer"], ["transfer-main-source", ...transferDerived], ["transfer-main-source"], ["transfer-main-answer"], ["example-main-answer", "transfer-main-answer"]];
  const draft = {
