...
const scenePurposes = ["Vorwissen aktivieren und die Leitfrage öffnen.", "Das überprüfbare Lernziel transparent machen.", "Die semantische Darstellung am geprüften Beispiel modellieren.", "Den Lösungsweg in fachlich geordneter Folge erklären.", "Die Fehlvorstellung sichtbar machen und fachlich korrigieren.", "Das Verfahren auf die Transferaufgabe anwenden.", "Eine eigenständige Entscheidung mit Denkzeit einfordern.", "Die geprüfte Transferlösung auflösen und begründen.", "Relation, Einheit und Ergebnis knapp sichern."] as const;
