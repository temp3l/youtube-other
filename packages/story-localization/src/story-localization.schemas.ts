...
export const compactCanonicalStoryFactsSchema = z.object({
  ...
  supportingCharacters: z.array(z.string().min(1)).optional(),
  concreteLocations: z.array(z.string().min(1)).optional(),
  keyObjects: z.array(z.string().min(1)).optional(),
  threatMechanism: z.string().min(1).optional(),
  supernaturalRule: z.string().min(1).optional(),
  protagonistAttachment: z.string().min(1).optional(),
  threatTemptation: z.string().min(1).optional(),
  emotionalCost: z.string().min(1).optional(),
  finalDecision: z.string().min(1).optional(),
  forbiddenInventions: z.array(z.string().min(1)).optional(),
  localizationPreservationRules: z.array(z.string().min(1)).optional(),
