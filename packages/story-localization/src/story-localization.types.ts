...
export interface CompactCanonicalStoryFacts {
  ...
  readonly supportingCharacters?: readonly string[];
  readonly concreteLocations?: readonly string[];
  readonly keyObjects?: readonly string[];
  readonly threatMechanism?: string;
  readonly supernaturalRule?: string;
  readonly protagonistAttachment?: string;
  readonly threatTemptation?: string;
  readonly emotionalCost?: string;
  readonly finalDecision?: string;
  readonly forbiddenInventions?: readonly string[];
  readonly localizationPreservationRules?: readonly string[];
