...
export const reviewSdkV1Operations = {
  ...
  listReviewQueue: {
    method: "GET",
    path: "/v1/workspaces/{workspace}/projects/{project}/review-queue",
    successStatus: "200",
    responseSchema: "ReviewQueuePage",
    requestSchema: null,
    requiredHeaders: [],
    problemResponses: true,
  },
  submitApprovalChallenge: {
    method: "POST",
    path: "/v1/workspaces/{workspace}/projects/{project}/approval-challenges",
    successStatus: "201",
    responseSchema: "ApprovalChallenge",
    requestSchema: "ApprovalChallengeSubmitInput",
    requiredHeaders: ["IdempotencyKey"],
    problemResponses: true,
  },
  claimApprovalChallenge: {
    method: "POST",
    path: "/v1/workspaces/{workspace}/projects/{project}/approval-challenges/{challenge}:claim",
    successStatus: "200",
    responseSchema: "ReviewQueueItem",
    requestSchema: null,
    requiredHeaders: [],
    problemResponses: true,
  },
  listApprovalHistory: {
    method: "GET",
    path: "/v1/workspaces/{workspace}/projects/{project}/approval-history",
    successStatus: "200",
    responseSchema: "ApprovalHistoryPage",
    requestSchema: null,
    requiredHeaders: [],
    problemResponses: true,
  },
  getApprovalValidity: {
    method: "GET",
    path: "/v1/workspaces/{workspace}/projects/{project}/approvals/{approval}/validity",
    successStatus: "200",
    responseSchema: "ReviewValidity",
    requestSchema: null,
    requiredHeaders: [],
    problemResponses: true,
  },
