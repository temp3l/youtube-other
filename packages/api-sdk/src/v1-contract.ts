...
export const SDK_V1_OPERATIONS = {
  ...
  forkEpisodeFromPattern: { method: "POST", path: "/v1/workspaces/{workspace}/projects/{project}/episodes/{episode}:fork-pattern", successStatus: "201", responseSchema: "PatternForkResult", requestSchema: "ForkEpisodeFromPatternInput", requiredHeaders: ["IdempotencyKey"], problemResponses: true },
...
export const SDK_V1_OBJECT_SCHEMAS = {
  ...
  PatternLineage: { required: ["patternId", "configurationRevision", "dependencyFingerprint", "provenanceHash"], additionalProperties: false },
  ForkEpisodeFromPatternInput: { required: ["expectedSourceRevision", "patternLineage"], additionalProperties: false },
  PatternForkResult: { required: ["id", "revision", "lifecycleState", "sourceEpisodeId", "sourceEpisodeRevision", "patternLineage"], additionalProperties: false },
