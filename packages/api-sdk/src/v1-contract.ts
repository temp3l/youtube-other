...
export const SDK_V1_OPERATIONS = {
  ...
  listProjects: {
    method: "GET", path: "/v1/workspaces/{workspace}/projects", successStatus: "200",
    responseSchema: "ProjectPage", requestSchema: null, requiredHeaders: [], problemResponses: true,
  },
  createEpisode: {
    method: "POST",
  ...
  listEpisodes: {
    method: "GET", path: "/v1/workspaces/{workspace}/projects/{project}/episodes", successStatus: "200",
    responseSchema: "EpisodePage", requestSchema: null, requiredHeaders: [], problemResponses: true,
  },
  getEpisode: {
    method: "GET",
  ...
  listAssets: {
    method: "GET", path: "/v1/workspaces/{workspace}/projects/{project}/assets", successStatus: "200",
    responseSchema: "AssetPage", requestSchema: null, requiredHeaders: [], problemResponses: true,
  },
  getApprovalChallenge: {
    method: "GET", path: "/v1/workspaces/{workspace}/projects/{project}/approval-challenges/{challenge}", successStatus: "200",
    responseSchema: "ApprovalChallenge", requestSchema: null, requiredHeaders: [], problemResponses: true,
  },
  listValidations: {
    method: "GET",
