...
export const STRATEGIC_FULL_TASK_DEFINITIONS = [
  ...
  },
  {
    ...
    owner: "@mediaforge/strategic-reinvention",
    executionKind: "deterministic",
    dependencies: ["strategic.short-extract"],
  ...
  },
  {
    ...
    owner: "@mediaforge/strategic-reinvention",
    executionKind: "deterministic",
    dependencies: ["strategic.localization-approval"],
  ...
  },
  {
    ...
    owner: "@mediaforge/strategic-reinvention",
    executionKind: "deterministic",
    dependencies: ["strategic.render-qa"],
  ...
  },
  {
    ...
    owner: "@mediaforge/strategic-reinvention",
    executionKind: "manual-approval",
    dependencies: ["strategic.publish-dry-run"],
