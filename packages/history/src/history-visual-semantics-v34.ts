...
const CAUSAL_NARRATION_PATTERN =
  /\b(?:because|led to|caused|resulted|therefore|compelled|forced|triggered|combin(?:e|ed|ing)|contribut(?:e|ed|ing)?|interdepend|disrupt(?:ed|ion)?|unless|collapse|pressure|failure|depended?|fragmented)\b/iu;
