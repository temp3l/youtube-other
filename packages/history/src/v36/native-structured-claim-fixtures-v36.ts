    ...
    claims: [
      ...
      },
      {
        ...
        propositions: [{
          ...
          participants: { record: concept("Reliefs at Medinet Habu"), evidence: concept("ships, warriors, families, and battle scenes") },
          subject: "record",
          predicate: "contains-evidence-of",
          object: "evidence",
          roles: [{ role: "evidence-target", participant: "record" }, { role: "evidence-item", participant: "evidence" }],
          assertionStatus: "asserted",
          qualifiers: [{ kind: "grouped-concept", value: "ships, warriors, families, and battle scenes" }],
        }],
      },
    ],
  },
