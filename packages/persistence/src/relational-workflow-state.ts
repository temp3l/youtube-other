...
CREATE TABLE IF NOT EXISTS projects (
  ...
  name TEXT NOT NULL,
  profile TEXT NOT NULL CHECK (profile IN ('dark_truth', 'mathematics_education', 'dynamic_generic', 'history', 'veronicabenini')),
...
ALTER TABLE projects ADD CONSTRAINT projects_profile_check
  CHECK (profile IN ('dark_truth', 'mathematics_education', 'dynamic_generic', 'history', 'veronicabenini'));
