...
Task: plan all remaining work for Planning Batch 2 only.
...
This is a strictly planning-only task. Do not implement production code. Do not “prepare” implementation by editing code. Do not begin batch 3, 4, or 5 work. Do not drift into unrelated refactors.
...
- Ignore `README.md` for architecture guidance.
- Ignore `docs.bak`.
...
- English full generation and optimization
...
Create repository-grounded planning docs, not implementation.

Preferred deliverables:
- `docs/plans/05-full-generation-plan.md`
- `docs/plans/06-localization-plan.md`
- `docs/plans/07-short-adaptation-and-generation-plan.md`

If you choose a different split, you must justify it in the docs themselves and keep it equally specific.
