# VRI-07 — Persisted camera direction and selective references

## Objective

Generalize persisted direction and reference selection; attach references only when relevant.
...
VER-033 (PARTIAL), VER-034 (PARTIAL)
...
packages/history/src/history-visual-direction-resolver-v1.ts; packages/history/src/history-person-reference-v35.ts; packages/veronica-media/src
...
**EXCLUSIVE_WRITE_OWNER:** generic direction/reference contract. Other tasks must use additive/disjoint files or wait for this owner.
