...
Add labeled comparisons without causal claims or profile auto-mutation.
...
packages/domain/src/genre-production-intelligence.ts; apps/api/src; apps/web/src
...
**EXCLUSIVE_WRITE_OWNER:** analytics comparison query/API. Other tasks must use additive/disjoint files or wait for this owner.
