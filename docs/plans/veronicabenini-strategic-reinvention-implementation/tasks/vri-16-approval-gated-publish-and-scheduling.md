# VRI-16 — Approval-gated publish and scheduling

## Objective

Wire editions to generic publish preflight, intent, reconciliation, and audited scheduling.
...
VER-111 (PARTIAL), VER-112 (PARTIAL), VER-113 (ABSENT)

## Existing implementation/evidence

Generic publisher/reconciliation are durable but not yet a Veronica edition path.
...
packages/youtube-upload/src/generic-media-publish.ts; packages/application/src/publication-safety.ts; packages/persistence/src/postgres-workflow-repository.ts
...
**EXCLUSIVE_WRITE_OWNER:** publication intent and contract extensions. Other tasks must use additive/disjoint files or wait for this owner.
