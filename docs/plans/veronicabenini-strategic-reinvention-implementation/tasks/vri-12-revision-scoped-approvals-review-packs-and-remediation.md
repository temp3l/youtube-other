...
Make durable scoped approvals authoritative and assemble delta-focused packs.
...
VER-070 (PARTIAL), VER-071 (PARTIAL), VER-072 (PARTIAL), VER-073 (ABSENT), VER-074 (PARTIAL)
...
packages/workflow-engine/src/workflow-store.ts; packages/veronica-media/src/review-pack; packages/application/src/usage-audit.ts
...
**EXCLUSIVE_WRITE_OWNER:** workflow approval records. Other tasks must use additive/disjoint files or wait for this owner.
