# VRI-14 — FFmpeg render derivatives and previews

## Objective

Render locale/format units from approved composition manifests with deterministic evidence.
...
VER-100 (PARTIAL), VER-101 (PARTIAL), VER-103 (PARTIAL)
...
packages/veronica-media/src/rendering; packages/rendering; packages/process-runner
...
**EXCLUSIVE_WRITE_OWNER:** render-manifest adapter. Other tasks must use additive/disjoint files or wait for this owner.
