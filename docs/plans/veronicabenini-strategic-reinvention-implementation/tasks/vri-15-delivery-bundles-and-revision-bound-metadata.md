# VRI-15 — Delivery bundles and revision-bound metadata

## Objective

Generate editable locale metadata and safe delivery packages without visual invalidation.
...
VER-102 (PARTIAL), VER-110 (PARTIAL)
...
packages/metadata/src/youtube-metadata.ts; packages/veronica-media/src/review-pack; packages/shared/src/artifact-path-resolver.ts
...
**EXCLUSIVE_WRITE_OWNER:** delivery-bundle manifest. Other tasks must use additive/disjoint files or wait for this owner.
