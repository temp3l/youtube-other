# VRI-05 — Source-led editorial outline and narration revisions

## Objective

Replace fixture fallback narration with revisioned source-led outline, spoken script, timing, diffs, and freeze.
...
VER-020 (ABSENT), VER-021 (ABSENT), VER-022 (PARTIAL), VER-023 (PARTIAL), VER-024 (ABSENT), VER-025 (PARTIAL)

## Existing implementation/evidence

`runStrategicSourceAdaptation` exists, but the strategic pipeline catches failures and writes fixtures.
...
packages/strategic-reinvention/src/source-adaptation-bridge.ts; packages/veronica-media/src/narration/revision.ts; packages/story-localization/src/narration-constraints.ts
...
**EXCLUSIVE_WRITE_OWNER:** strategic narration adapter. Other tasks must use additive/disjoint files or wait for this owner.
