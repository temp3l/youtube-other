# VRI-09 — Shared semantic content with 16:9 and 9:16 derivatives

## Objective

Model independent format compositions over one narration/visual semantic revision.
...
VER-040 (PARTIAL), VER-041 (PARTIAL), VER-042 (PARTIAL)
...
packages/veronica-media/src/composition/aspect-ratio.ts; packages/rendering; packages/domain/src/workflow-contracts.ts
...
**EXCLUSIVE_WRITE_OWNER:** composition artifact contract. Other tasks must use additive/disjoint files or wait for this owner.
