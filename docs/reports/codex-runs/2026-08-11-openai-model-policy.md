...
Changed paths: `packages/shared/src/openai-model-policy.ts`, `packages/config/src/index.ts`, `apps/cli/src/{index,story-*,veronica-*}.ts`, `packages/history/src/{history-research-*,v36/*}.ts`, media/chat adapters, `pnpm-lock.yaml`, focused tests, `.env.example`.
