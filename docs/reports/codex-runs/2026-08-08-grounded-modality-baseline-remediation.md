...
| **Grounded remediation** | `history-v3.5-grounded-modality-baseline` | *(this commit)* |
...
- Locator maps (17) remain above semantic baseline (9); further tuning deferred.
- Geo coverage warnings (15) remain; entity/geography layer unchanged by design.
